...
class Files
{
    static void Main()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            var root = input[0];
            var fileParams = input[input.Length - 1].Split(new[] { ';' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        var queryParams = Console.ReadLine().Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
