...
class Program
{
    static void Main()
    {
        ...
        {
            case 1:
                numberOfSetWord = "First";
                break;
            case 2:
                numberOfSetWord = "Second";
                break;
            case 3:
                numberOfSetWord = "Third";
                break;
            case 4:
                numberOfSetWord = "Fourth";
                break;
            case 5:
                numberOfSetWord = "Fifth";
                break;
            case 6:
                numberOfSetWord = "Sixth";
                break;
            case 7:
                numberOfSetWord = "Seventh";
                break;
            case 8:
                numberOfSetWord = "Eight";
                break;
            case 9:
                numberOfSetWord = "Ninth";
                break;
            case 10:
                numberOfSetWord = "Tenth";
                break;
        }
